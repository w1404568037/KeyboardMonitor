...
namespace KeyboardMonitor.KeyboardHook
{
	/// <summary> 
	...
	CallingConvention = CallingConvention.StdCall)]
		...
		/// </summary> 
		public KeyBordHook(KeyEventHandler KeyDownEvent, KeyPressEventHandler KeyPressEvent, KeyEventHandler KeyUpEvent)
		{
			this.OnKeyDownEvent += KeyDownEvent;
			this.OnKeyPressEvent += KeyPressEvent;
			this.OnKeyUpEvent += KeyUpEvent;
			Start();
		}
		//析构函数. 
		~KeyBordHook()
